...
exports.getAllStudentCount = (req, res, next) => {
  Student.count()
    .then((data) => {
      res.status(200).json({
        message: "Student created Successfully!",
...
exports.getAllStudentLevel = (req, res, next) => {
  Student.aggregate([
    {
      $lookup: {
        from: "quizzes", //Specifies the collection in the same database to perform the join with.
        ...
        as: "quiz", //Specifies the name of the new array field to add to the input documents.
